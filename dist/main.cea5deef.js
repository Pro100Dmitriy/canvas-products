...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"assets/js/import-liberis.js":[function(require,module,exports) {
"use strict";
...
var _slick = _interopRequireDefault(require("../../node_modules/slick-carousel/slick/slick"));
...
},{"../../node_modules/jquery/dist/jquery":"node_modules/jquery/dist/jquery.js","../../node_modules/slick-carousel/slick/slick":"node_modules/slick-carousel/slick/slick.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var product_data = {
  'cls-1': {
    id: 1,
    title: 'Плед Люция-деко',
    price: 11 + ' BYN',
    description: 'Психосоматика значительно просветляет индивидуальный блеск, независимо от психического состояния пациента.',
    img: ['https://blueins.by/wp-content/uploads/2021/07/5_1_800x800-min.jpg', 'https://blueins.by/wp-content/uploads/2021/07/5_2_1000x1000-min.jpg']
  },
  'cls-2': {
    id: 2,
    title: 'Плед Индиго',
    ...
    img: ['https://blueins.by/wp-content/uploads/2021/07/1_1_800x800-min.jpg', 'https://blueins.by/wp-content/uploads/2021/07/1_2_1000x1000-min.jpg']
  },
  'cls-3': {
    id: 3,
    title: 'Плед Зигзаг',
    ...
    img: ['https://blueins.by/wp-content/uploads/2021/07/2_1_800x800-min.jpg', 'https://blueins.by/wp-content/uploads/2021/07/2_2_1000x1000-min.jpg']
  },
  'cls-4': {
    id: 4,
    title: 'Плед Бонди',
    ...
    img: ['https://blueins.by/wp-content/uploads/2021/07/4_1_800x800-min.jpg', 'https://blueins.by/wp-content/uploads/2021/07/4_2_1000x1000-min.jpg']
  },
  'cls-5': {
    id: 5,
    title: 'Плед Шотландия',
    price: 55 + ' BYN',
    description: 'Психосоматика значительно просветляет индивидуальный блеск, независимо от психического состояния пациента. Все это побудило нас обратить внимание на то, что фаза возможна. Краевая часть артезианского бассейна колеблет тектонический психоз. Плато однократно.',
    img: ['https://blueins.by/wp-content/uploads/2021/07/6_1_800x800-min.jpg', 'https://blueins.by/wp-content/uploads/2021/07/6_2_1000x1000-min.jpg']
  },
  'cls-6': {
    id: 6,
    title: 'Плед Пташки',
    price: 66 + ' BYN',
    description: 'Психосоматика значительно просветляет индивидуальный блеск, независимо от психического состояния пациента. Все это побудило нас обратить внимание на то, что фаза возможна. Краевая часть артезианского бассейна колеблет тектонический психоз. Плато однократно.',
    img: ['https://blueins.by/wp-content/uploads/2021/07/3_1_800x800-min.jpg', 'https://blueins.by/wp-content/uploads/2021/07/3_2_1000x1000-min.jpg']
  }
};
...
function svghover($container, _ref, prod_data) {
  ...
  function click(_ref3) {
    ...
    var over_data = prod_data[target.getAttribute('class')];
    over.show({
    ...
    document.querySelector('#close-overlay-menu-button').addEventListener('click', function (e) {
      return over.hide();
    });
    $("#overlay-slick").slick({
      infinite: true,
...
},{"./import-liberis":"assets/js/import-liberis.js","../sass/main.sass":"assets/sass/main.sass","./tooltip":"assets/js/tooltip.js","./data":"assets/js/data.js","./utils":"assets/js/utils.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
